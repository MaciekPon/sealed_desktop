...
import { useAliasContacts, useAliasConversation, useDeleteAliasContact, useMarkAliasConversationRead, useRenameAliasContact, useSendAliasMessage } from "../../queries/alias";
...
export function ChatWindow() {
  ...
  if (!selectedWallet && !selectedAliasContactId) {
    return (
  ...
  const headerName = isAlias ? (aliasContact?.label ?? "Alias chat") : (contact?.username ?? formatWalletAddress(selectedWallet as string));
    ...
    <div className="chat-window">
      <div className="chat-window__header">
        ...
        <div>
          ...
          {!isAlias && contact?.username && <p className="chat-window__header-address">{truncateWalletAddress(selectedWallet as string)}</p>}
